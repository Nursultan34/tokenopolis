	...
	return (
		<div class="flex flex-row justify-end items-end h-[calc(3rem)] -mt-2">
			<span
				...
				class={`${props.typeCard === "all" ? "text-xl" : "text-base"} font-medium justify-center items-center`}
			>
				{props.first}
			</span>
			<span
				style={{ display: "flex", flex: 1, marginLeft: props.typeCard === "all" ? 120 : 100 }}
				class={`justify-center items-center text-gray-dashed ${props.typeCard === "all" ? "text-sm" : "text-xs"}`}
			>
				{props.second}
			</span>
			<span
				style={{ display: "flex", flex: 1, marginLeft: props.typeCard === "all" ? 40 : 40 }}
				class={`justify-end items-center text-gray-dashed ${props.typeCard === "all" ? "text-sm" : "text-xs"} `}
			>
				{props.three}
			</span>
