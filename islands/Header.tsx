		...
		<header class="row h-[10%] justify-center items-center h-28 flex-1 flex-shrink-0 w-full bg-white-dark">
			...
			<div class="flex-auto flex flex-row w-max items-center justify-end">
				<div class="flex flex-row justify-center items-center mr-4">
					...
					<div class="mr-7">
						<img src={asset("headerImage/Account.png")} style={{ width: 44, height: 44 }} class="hover:opacity-70 mr-3" onClick={() => openPopUp(PopUp.Settings)} />
						<img class="mr-3" src={asset("headerImage/Message.png")} style={{ width: 44, height: 44 }} onClick={() => openPopUp(PopUp.Notifications)} />
						{match(currentPopUp, [
							[PopUp.Notifications, <NotificationsPopUp />],
							[PopUp.Settings, <SettingsPopUp isDark={isDark} toggleTheme={toggleTheme} />],
							[PopUp.None, <></>],
						])}
					</div>
				</div>
								...
								<>
									...
									>
										<text class="mr-4 flex flex-row justify-center items-center font-light">
											<img class="mr-3" src={asset("headerImage/Vector.png")} style={{ width: 7.1, height: 15.84 }} /> ВЫБРАТЬ ЯЗЫК
										</text>
