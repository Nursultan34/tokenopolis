...
export default function CardObjectComponent (props : ICardObjectComponent) {
    ...
    return(
        <div className={"w-full bg-gray-light flex flex-row rounded justify-center items-center mt-2 hover:shadow-side"} style={{height: props.cardType === 'all' ? 120 : 100}} onClick={()=>console.log('rer')}>
