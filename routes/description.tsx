  ...
  return (
    <>
      ...
      <main class="bg-gray-white dark:bg-black text-black">
        <div className="mx-auto mt-[15px] w-[1479px] h-[2302px]">
  ...
  return (
    <div class="w-[804px] flex flex-col gap-[32px]">
      ...
      <div class="flex flex-col gap-y-[30px] text-[18px]">
        ...
        <p>
          Предлагаем апартаменты с 3 спальнями, 3 ванными комнатами и
          пристроенным гаражом на 2 машины. Здесь есть кухня с техникой из
          нержавеющей стали, фартук из плитки, большая зона для завтрака и
          отдельная столовая. Все три спальни просторные, с гардеробными. Сзади
          внутренний дворик с установленным ограждением, создающим отличное
          пространство для развлечений.
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-[10px] text-[18px]">
        ...
        <p>
          Прогноз арендной платы основан на чрезвычайном потенциале зимнего
          сезона, так как три долины пользуются определенным снежным покровом с
          начала декабря до начала мая, а летний бонус связан с развитием,
          предпринятым регионом для развития летнего туризма. Летний туризм в
          настоящее время в основном основан на велотуризме, поскольку мы
          находимся в центре этапов Тур де Франс.
        </p>
      </div>
      ...
      <div class="flex flex-col gap-y-[10px] text-[18px]">
        ...
        <p>
          Не беспокойтесь, все сдаваемые в аренду объекты недвижимости проходят
          строгий процесс отбора и предварительно проверяются нашей командой.
          Вместо того, чтобы сосредотачиваться на выборе отдельных объектов для
          инвестирования, свои инвестиции между несколькими доступными объектами
          недвижимости.
        </p>
      </div>
  ...
  return (
    <div class="w-[510px] flex flex-col ">
      ...
      <p class="mt-[9px] w-[340px] text-[14px]">
        * этот проект будет профинансирован, если будет достигнута цель в
        размере 1 441 124,03 Евро. Если цель не будет достигнута, вам будет
        возвращено 100% ваших инвестиций.
      </p>
